...
export const BLOG_SINGLE_CATEGORY_SUCCESS="BLOG_SINGLE_CATEGORY_SUCCESS";
export const BLOG_SINGLE_CATEGORY_REQUEST="BLOG_SINGLE_CATEGORY_REQUEST";
export const BLOG_SINGLE_CATEGORY_FAILED="BLOG_SINGLE_CATEGORY_FAILED";
